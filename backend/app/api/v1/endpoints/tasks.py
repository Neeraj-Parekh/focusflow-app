...
async def create_task(
    ...
    background_tasks.add_task(
        generate_ai_suggestions_for_task,
        db_task.id,
        current_user.id
    )
...
async def get_ai_suggestions_for_task(
    ...
    try:
        ...
        return {
            ...
            "recommendations": suggestions.get("reasoning", "No specific recommendations available")
        }
...
async def increment_pomodoro(
    ...
    if task.completed_pomodoros >= task.estimated_pomodoros and task.status != "completed":
