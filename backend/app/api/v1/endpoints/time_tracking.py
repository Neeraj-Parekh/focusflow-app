...
async def start_time_entry(
    ...
    if running_entry:
        ...
        running_entry.duration = int((running_entry.end_time - running_entry.start_time).total_seconds())
...
async def update_time_entry(
    ...
    if "end_time" in update_data and update_data["end_time"]:
        update_data["duration"] = int((update_data["end_time"] - entry.start_time).total_seconds())
...
async def get_time_tracking_stats(
    ...
    billable_time = sum(entry.duration for entry in entries if entry.billable and entry.duration)
    total_revenue = sum(
...
async def get_active_time_entry(
    ...
    current_duration = int((datetime.utcnow() - active_entry.start_time).total_seconds())
