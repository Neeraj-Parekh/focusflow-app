...
class IoTService:
    ...
    async def trigger_automation(
        self, trigger_event: str, context: Dict[str, Any]
    ) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"actions_executed": [], "devices_affected": [], "error": str(e)}

    async def execute_device_action(
        self, device_type: str, action: str, context: Dict[str, Any]
    ) -> Dict[str, Any]:
        ...
        try:
            ...
            if device_type == "light":
                ...
                return await self._execute_air_quality_action(
                    action, ip_address, context
                )
            else:
    ...
    async def _execute_light_action(
        self, action: str, ip_address: str, context: Dict[str, Any]
    ) -> Dict[str, Any]:
        """Execute light-specific actions"""

        action_map = {
            "focus_mode": {"brightness": 80, "color": "#ffffff", "temperature": 5000},
            "break_mode": {"brightness": 60, "color": "#ffa500", "temperature": 3000},
            "celebration_flash": {"effect": "flash", "color": "#00ff00", "duration": 3},
            "productivity_boost": {
                "brightness": 90,
                "color": "#00aaff",
                "temperature": 5500,
            ...
            "dim_lights": {"brightness": 20, "color": "#ff6600", "temperature": 2700},
        }
    ...
    async def _execute_speaker_action(
        self, action: str, ip_address: str, context: Dict[str, Any]
    ) -> Dict[str, Any]:
        """Execute speaker-specific actions"""

        action_map = {
            "play_focus_sound": {"sound": "white_noise", "volume": 40, "loop": True},
            "play_completion_sound": {"sound": "chime", "volume": 60, "duration": 2},
            "play_relaxing_sound": {"sound": "nature", "volume": 30, "loop": True},
            "play_gentle_chime": {"sound": "soft_bell", "volume": 50, "duration": 1},
            "stop_sounds": {"action": "stop", "fade_out": True},
        }
    ...
    async def _execute_air_quality_action(
        self, action: str, ip_address: str, context: Dict[str, Any]
    ) -> Dict[str, Any]:
    ...
    async def _send_http_command(
        self, ip_address: str, endpoint: str, data: Dict[str, Any]
    ) -> Dict[str, Any]:
    ...
    async def ping_device(self, ip_address: str) -> bool:
        ...
        try:
            ...
            reader, writer = await asyncio.wait_for(
                asyncio.open_connection(ip_address, 80), timeout=3
            )
            writer.close()
